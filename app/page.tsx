          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Specializing in React, Next.js, and TypeScript. Passionate about creating beautiful user interfaces with great user experience.
                </p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Expert in Express, Nest.js, MongoDB, and PostgreSQL. Focuses on building scalable and secure backend systems.
                </p>
                <div className="flex space-x-3">
                  <a href="#" className="text-gray-500 hover:text-gray-800 dark:hover:text-gray-300">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Skilled in both frontend and backend technologies with a special focus on Django and Python for complex applications.
                </p>
                <div className="flex space-x-3">
                  <a href="#" className="text-gray-500 hover:text-gray-800 dark:hover:text-gray-300">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
